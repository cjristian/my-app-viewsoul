    ...
    return (
        ...
        {[...Array(3)].map((_, index) => (
          <div key={index} className="animate-pulse mb-4">
            <div className="text-lg mb-2 bg-gray-800 h-6 w-36 rounded-md"></div>
            <div className="text-lg mb-2 bg-gray-800 h-6 w-96 rounded-md"></div>
            <div className="text-lg mb-2 bg-gray-800 h-6 w-80 rounded-md"></div>
            <div className="text-lg mb-2 bg-gray-800 h-6 w-96 rounded-md"></div>
          </div>
        ))}
    ...
    return (
        <div className="flex flex-col items-center mb-4 mt-20 relative z-10">
            <div className="flex flex-col items-center" >
                <div className="rounded-full w-32 h-32 mb-2 bg-gray-300"></div>
