...
export default function CardProfile({ id }: PostProfileProps) {
    ...
    return (
        <div className="relative flex flex-col items-center w-full h-full">
            ...
            <Link
                href={"/edit-profile"}
                className="absolute slide-out-to-bottom-full right-4 flex items-center justify-center w-12 h-12 rounded-full bg-black/80 text-white hover:bg-gray-800 transition md:bottom-80 md:right-8 lg:bottom-80 lg:right-12 "
